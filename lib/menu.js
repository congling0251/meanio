...
function mapDoStrip (v) {
  return v ? (v.strip ?v.strip():new MenuItem(v).strip()) : undefined;
}
...
function supportMenus(Meanio){
  ...
  Menus.prototype.add = function(options) {
    ...
    if (options.submenus && _.isArray(options.submenus)){
       options.submenus = options.submenus.map(function(submenu){
